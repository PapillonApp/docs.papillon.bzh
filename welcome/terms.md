...
* Papillon est un client de vie scolaire libre, gratuit, indépendant, collaboratif, open source, et aucunement affilié à une quelconque entreprise.
...
* Vos données, aussi bien scolaires que personnelles, ne sont transmises qu'aux serveurs officiels des services de vie scolaire via leurs APIs, conformément à [la politique de confidentialité.](https://github.com/PapillonApp/docs/blob/gitbook/legal/broken-reference/README.md). Papillon n'est pas responsable de la sécurité de ces données conservées localement sur votre appareil.
...
En cas de problème avec l'application ou son traitement des données, merci de nous contacter à l'adresse suivante : [bureau@papillon.bzh](mailto:bureau@papillon.bzh).
